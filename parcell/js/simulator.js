// simulator.js : calculs financiers + carte Leaflet + drawers
// Les constantes globales (COLORS, OPT_BONUS, LYON_QUARTIERS, CP_TO_QUARTIER)
// et l'etat partage (simMode, simType, simMeuble, activeOpts, simData, leafletMap,
// pgCache, etc.) sont declares dans cities_loader.js. Ne PAS les redeclarer ici
// (sinon SyntaxError "Identifier already declared" qui empeche le script de se charger).
