...
function renderAnalyseTab() {
  ...
  <div id="tab-analyse" class="tab-content active">
    ...
    <div class="sources-bar">
      ...
      <a href="https://www.meilleursagents.com/prix-immobilier/" target="_blank">Prix m² → MeilleursAgents</a>
...
// ── Profil : remplit le formulaire avec les données réelles ──
...
function showToast(msg, type = 'ok') {
  ...
  if (!t || !m) return;
  m.textContent = msg;
  t.style.borderColor = type === 'err' ? 'rgba(248,113,113,0.3)' : type === 'warn' ? 'rgba(201,168,76,0.3)' : 'rgba(52,211,153,0.3)';
  t.style.color = type === 'err' ? 'var(--red)' : type === 'warn' ? 'var(--gold)' : 'var(--green)';
